...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        saver = tf.train.Saver(var_to_restore, max_to_keep=1)
        ...
        with sess.as_default():
            ...
            while epoch < args.max_nrof_epochs:
                ...
                # Evaluate on LFW
                if args.lfw_dir:
                    acc, c_loss = evaluate(sess, enqueue_op, image_paths_placeholder, labels_placeholder, phase_train_placeholder,
