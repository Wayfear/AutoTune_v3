...
def main(args):
    ...
    # write meta emb
    meta_data_path = os.path.join(log_dir, 'metadata.tsv')
    tools.generate_metadata_file(nrof_classes, meta_data_path)
    ...
    with tf.Graph().as_default():
        ...
        # get soft labels
        with open(args.soft_label_path, 'rb') as f:
        ...
        if args.center_loss_factor > 0.0:
            prelogits_center_loss, centers_update = facenet.fuzzy_center_loss(prelogits, soft_label_batch,
            ...
            config.model_checkpoint_path = os.path.join(model_dir, 'model-%s.ckpt' % subdir)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--pretrained_model', type=str,
                        help='Load a pretrained model before training starts.', default='../models/facenet/pretrain/model-20170511-185253.ckpt-80000')
    ...
    parser.add_argument('--soft_label_path',
                        help='Soft label path.', default='../2017/train/soft_label.pk')
    ...
    parser.add_argument('--lfw_pairs', type=str,
                        help='The file containing the pairs to use for validation.', default='../2017/pairs.txt')
