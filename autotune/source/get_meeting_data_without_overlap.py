...
# section_time = timedelta(minutes=20)
...
while True:
    ...
    for pic in pic_paths:
        ...
        copyfile(pic, join(middle_data_path, folder_name, cfg['base_conf']['mtcnn_origin_data_path'], '%s_%s_%d.jpeg' % (meeting_n, iou_num, index)))
        print(join(middle_data_path, folder_name, cfg['base_conf']['mtcnn_origin_data_path'], '%s_%s_%d.jpeg' % (meeting_n, iou_num, index)))
        index += 1
